...
> **Status:** This is the archived accepted execution prompt. Version 2.1 development was explicitly authorized on 2026-07-20. On 2026-08-22 a separate user directive authorized Version 2.2 development specifically for GP/OMM catalog continuity, not the collision-likelihood scope originally planned below. ADR 0004 records that rebaseline. No version was promoted, earlier gates remain open, and the archived prompt body below is preserved unchanged.
