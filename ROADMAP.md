...
Detailed method and validation limits are in `docs/science/EXPERIMENTAL_CONJUNCTION_SCREENING_V2.md` and `docs/science/EXPERIMENTAL_FULL_CATALOG_SCREENING_V2_1.md`. ADR 0004 records the GP/OMM boundary, ADR 0005 records browser state/time/motion continuity, and ADR 0006 records the SATCAT-scoped tracked inventory. Auditable switches and rollback behavior are in `release/feature-flags.json`, `docs/engineering/ROLLBACK.md`, `ROLLBACK_V2_1.md`, `ROLLBACK_V2_2.md`, and `ROLLBACK_V2_3.md`.
