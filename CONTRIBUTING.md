...
- Preserve NORAD identifiers as strings, keep OMM canonical fields, and never manufacture TLE or bypass provider request guards. External-data tests use fixed fixtures or mocked fetches.
...
- For Version 2.2 catalog, timeline, or browser-continuity work, run the required matrix in `Test_and_Integration.md` and `docs/engineering/RELEASE_CHECKLIST_V2_2.md`; a live provider smoke test is separate, guarded operator evidence.
